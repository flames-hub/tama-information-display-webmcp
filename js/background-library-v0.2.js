import { saveRuntimeSettings } from "./config-v0.2.js";
...
export class BackgroundLibraryController {
  ...
  createCard(image) {
    ...
    meta.append(category, statusChip);
  ...
  openPreview(id) {
    ...
    document.querySelector("#background-preview-category").textContent = this.categoryLabel(image.category);
